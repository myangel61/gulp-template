...
gulp.task('scripts', function() {
	return gulp.src('app/js/common.js') // Берем Common.js
...
gulp.task('css-libs', ['sass'], function() {
	return gulp.src(['app/css/**/*.css', '!app/css/**/*.min.css', '!app/css/**/*fonts.css']) // Выбираем файл для минификации
...
gulp.task('build', ['clean', 'img', 'sass', 'scripts'], function() {
    ...
    var buildLibs = gulp.src('app/libs/**/*') // Переносим скрипты библиотеки в продакшен
